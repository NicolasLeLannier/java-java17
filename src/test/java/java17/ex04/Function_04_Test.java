...
public class Function_04_Test {
    ...
    // TODO AGE >=18
    Predicate<Person> adult = ad -> ad.getAge() >= 18;
    // end::adult[]
    ...
    Predicate<Person> lastnameIsFrance = ad -> ad.getLastname().equals("France");


    // TODO compléter la fonction
    // TODO le prédicat vérifie que le prénom est "Armor"
    Predicate<Person> firstnameIsArmor = ad -> ad.getFirstname().equals("Armor");;
    // end::predicateand[]
