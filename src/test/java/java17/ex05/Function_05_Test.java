...
public class Function_05_Test {
    ...
    Consumer<Person> changePasswordToSecret = ad -> ad.setPassword("secret");

    // TODO compléter la fonction
    // TODO vérifier que l'age > 4 avec une assertion JUnit
    Consumer<Person> verifyAge = ad -> {
    	assert ad.getAge() > 4;
    };

    // TODO compléter la fonction
    // TODO vérifier que le mot de passe est "secret" avec une assertion JUnit
    Consumer<Person> verifyPassword = ad -> {
    	assert ad.getPassword().equals("secret");
    };
    //end::functions[]
